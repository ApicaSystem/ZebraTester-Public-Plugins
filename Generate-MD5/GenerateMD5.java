 ...
 */
public class GenerateMD5 implements LoadtestPluginInterface
{
	private String inputString = "";		// input parameter #1 - label "Input string"
	
	private String outputMD5 = "";		// output parameter #1 - label "Output MD5 string"
	...
	{
		return "generates md5 hash from input\n\n";
	}
	...
	public void execute(Object context)
	{
		...
		outputMD5 = DigestUtils.md5Hex(inputString);
	 ...
	 *
	 * output parameter #1: (String) outputMD5 / default value = '' / label "Output MD5 string"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			...
			GenerateMD5 plugin = new GenerateMD5();
			plugin.construct(null);
			//plugin.setInputParameter(0, args[0]);
			plugin.setInputParameter(0, "apicasystem1");
			plugin.execute(null);
