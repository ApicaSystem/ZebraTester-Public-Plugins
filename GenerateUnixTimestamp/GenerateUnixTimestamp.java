 ...
 */
public class GenerateUnixTimestamp implements LoadtestPluginInterface
{
	private String timestamp = "";		// output parameter #1 - label "timestamp"
	...
	{
		return "Generate Unix Timestamp";
	}
	
	
	public String getPluginDescription()
	{
		return "Generates current unix timestamp 10 digit long.\n\n";
	}
	 ...
	 *
	 * output parameter #1: (String) timestamp / default value = '' / label "timestamp"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			...
			GenerateUnixTimestamp plugin = new GenerateUnixTimestamp();
