 ...
 */
public class News_parse implements LoadtestPluginInterface
{
	private String inputHTML = "";		// input parameter #1 - label "Input HTML"
	
	private String outputHREF = "";		// output parameter #1 - label "Output HREF"
	 ...
	 *
	 * input parameter #1: (String) inputHTML / default value = '' / label "Input HTML"
	 *
	...
	public void setInputParameter(int parameterNumber, Object parameterValue)
	{
		...
		{
			case 0:
				inputHTML = (String) parameterValue;
				break;
			default:
				break;
		}
	 ...
	 *
	 * output parameter #1: (String) outputHREF / default value = '' / label "Output HREF"
	 *
	...
	public static void main(String[] args)
	{
		try
		{
			...
			News_parse plugin = new News_parse();
